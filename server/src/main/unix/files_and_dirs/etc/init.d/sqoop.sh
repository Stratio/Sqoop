...
# Default-Stop: 0 1 6
# Short-Description: Sqoop
# Description: Description for sqoop
### END INIT INFO
# Developed by eruiz@stratio.com and aargomaniz@stratio.com
# Version: 0.1 2015
...
NAME="sqoop"
DESC="Description for sqoop"
BASEDIR=/opt/sds/sqoop
CONFDIR=/etc/sds/sqoop
LOGFILE=/var/log/sds/sqoop/sqoop.log
RUNFILE=$BASEDIR/bin/sqoop
pidDir=/var/run/sds/sqoop
serviceUser=stratio
